    ...
    <body class="min-h-screen bg-[#262626] text-zinc-100 antialiased">
        ...
        <header class="fixed inset-x-0 top-0 z-50 h-[120px] border-b border-zinc-700 bg-[#262626]">
            <div class="mx-auto flex h-full max-w-6xl items-center justify-between px-5 sm:px-8">
                <a href="{{ url('/') }}" class="flex items-center gap-3 underline-offset-4 hover:underline">
                    <img src="{{ asset('favicon.png') }}" alt="myChat" class="h-8 w-8 object-contain">
                    <span class="text-base font-semibold tracking-wide text-zinc-100">myChat</span>
                </a>
        ...
        <main class="mx-auto max-w-6xl px-5 sm:px-8">
            ...
            <section class="flex flex-col items-center py-20 text-center sm:py-28">
                <h1 class="text-5xl font-bold tracking-tight text-zinc-50 sm:text-6xl md:text-7xl">Secure, Private Messaging</h1>
                <p class="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
                    Secure messaging for people who want to chat privately and safely.
                </p>
            ...
            <section class="py-12">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <span class="text-sm font-semibold text-zinc-100">One‑on‑One Chats</span>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Connect privately with individual contacts.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <span class="text-sm font-semibold text-zinc-100">End‑to‑End Encryption</span>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">All messages are encrypted so only participants can read them.</p>
                    </div>
                </div>
            </section>
        ...
        <footer class="mt-12 border-t border-zinc-700">
            <div class="mx-auto flex max-w-6xl flex-col items-center gap-6 px-5 py-10 sm:flex-row sm:justify-between sm:px-8">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('favicon.png') }}" alt="myChat" class="h-6 w-6 object-contain">
