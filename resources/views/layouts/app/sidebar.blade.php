        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group :heading="__('Chat')" class="grid">
                    ...
                    <flux:sidebar.item icon="no-symbol" :href="route('blocks.index')" :current="request()->routeIs('blocks.*')" wire:navigate>
                        {{ __('Blocked') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="clock" :href="route('ignores.index')" :current="request()->routeIs('ignores.*')" wire:navigate>
                        {{ __('Ignored') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
